package kz.mircella.multithreading.deadlock;
    ...
    public void run() {
        while (!databaseRecords.isEmpty()) {
            ...
            if (!databaseRecords.isEmpty()) {
                ...
                databaseRecords.poll();
                System.out.println(this.name + " processed 1 database record for " + seconds + " seconds, records remained: " + databaseRecords.size());
            }
